...
export const modules = [
  // DAY 1: Intro & Networking Models - WITH TEXTBOOK CONTENT
  {
    day: 1,
    module_title: "Intro & Networking Models",
    
    // INTERACTIVE/CONVERSATIONAL CONTENT (Original)
...
- Draw the OSI model from memory daily`,
    ...
    // TEXTBOOK-STYLE CONTENT (New - Formal, Structured)
...
• **IP Address:** Logical address assigned to network devices for routing`,
    ...
    // SUMMARY CONTENT (Existing - Quick Reference)
